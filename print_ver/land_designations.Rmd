...
```{r bgc_summary, fig.height=9, fig.width=8}
```
...
```{r ecoreg_summary, fig.height=9, fig.width=8}
```
...
-   **Protected Lands (15.4%)**
    -   Includes **Parks & Protected Areas (15.0%)**, designations
        ...
        *long-term* conservation of nature and cultural values *and*
        ...
        agency ([BC Parks](/bcparks/) and [Parks
    ...
    -   Includes **Other Protected Lands (0.4%)**, such as B.C.’s
        ...
        values.
    -   Also includes designations enacted in legislation with a primary
...
-   **Resource Exclusion Areas (12.4%)**
    ...
    -   Some examples include designations such as no-harvest [Wildlife
        ...
        1)](https://www.for.gov.bc.ca/TASB/SLRP/GBR_LUO_2016.html)
...
-   **Spatially Managed Areas (24.5%)**
    ...
    -   Some examples include designations such as conditional-harvest
        ...
        [Visual Quality
        Objectives](http://www2.gov.bc.ca/gov/content?id=C45131B6586243CD8A91D399B5712256)—all
        designated under the [*Forest and Range Practices
        Act*](http://www.bclaws.ca/Recon/document/ID/freeside/00_02069_01)—
...
format](https://github.com/bcgov/EnvReportBC). Some designations were
...
The code for repeating the analysis presented on this page is available
on GitHub: the [spatial analysis](https://github.com/bcgov/EnvReportBC)
drawing together the over 40 spatial land designation data layers and
the [**R**](http://www.r-project.org) code to generate the [tabular data
summaries and map images](https://github.com/bcgov/EnvReportBC).
Overlaps among land designations have been accounted for in the
analyses. While B.C. does use aspatial land management tools, this
...
effectiveness of land designations has not been evaluated.
